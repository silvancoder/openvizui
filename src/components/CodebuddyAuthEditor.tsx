...
const CodebuddyAuthEditor: React.FC = () => {
    ...
    const fetchModels = async () => {
        ...
        if (!baseUrl || !apiKey) {
            message.warning(t('cliConfig.fields.apiKeyRequired', 'Please enter API Key and Base URL first'));
            return;
        }
        ...
        try {
            ...
            message.success(t('cliConfig.codebuddy.fields.modelsFetched', { count: models.length, defaultValue: `Successfully fetched ${models.length} models` }));
        } catch (error) {
    ...
    const items = [
        {
            key: 'env',
            label: (<span><KeyOutlined />{t('cliConfig.codebuddy.sections.env')}</span>),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Row gutter={16}>
                        <Col span={24}>
                            <Form.Item name={['env', 'CODEBUDDY_API_KEY']} label={t('cliConfig.codebuddy.fields.apiKey')}>
                                <Input.Password placeholder="sk-..." />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Form.Item name={['env', 'CODEBUDDY_BASE_URL']} label={t('cliConfig.codebuddy.fields.baseUrl')}>
                        <Input placeholder="https://api.codebuddy.com/v1" />
                    </Form.Item>
                    <Row gutter={16}>
                        <Col span={12}>
                            <Form.Item name={['env', 'CODEBUDDY_INTERNET_ENVIRONMENT']} label={t('cliConfig.codebuddy.fields.internetEnv')}>
                                <Select options={[
                                    { label: t('cliConfig.codebuddy.fields.internal'), value: 'internal' },
                                    { label: t('cliConfig.codebuddy.fields.ioa'), value: 'iOA' },
                                ]} />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item name={['env', 'CODEBUDDY_AUTH_TOKEN']} label={t('cliConfig.codebuddy.fields.authToken')}>
                                <Input.Password />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Row gutter={16} align="bottom">
                        <Col flex="1">
                            <Form.Item name="model" label={t('cliConfig.codebuddy.fields.model')} style={{ marginBottom: 0 }}>
                        ...
                        <Col>
                            <Button icon={<CloudDownloadOutlined />} onClick={fetchModels} loading={fetchingModels}>
                                {t('cliConfig.codebuddy.fields.fetchModels', 'Fetch Models')}
                            </Button>
                        </Col>
                    </Row>
                </div>
        ...
        {
            key: 'general',
            label: (<span><SettingOutlined />{t('cliConfig.codebuddy.sections.general')}</span>),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Row gutter={16}>
                        <Col span={12}>
                            <Form.Item name="language" label={t('cliConfig.codebuddy.fields.language')}>
                                <Select options={[
                        ...
                        <Col span={12}>
                            <Form.Item name="cleanupPeriodDays" label={t('cliConfig.codebuddy.fields.cleanupDays')}>
                                <InputNumber style={{ width: '100%' }} min={1} max={365} />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Space size="large" wrap>
                        <Form.Item name="autoUpdates" label={t('cliConfig.codebuddy.fields.autoUpdates')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="autoCompactEnabled" label={t('cliConfig.codebuddy.fields.autoCompact')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="alwaysThinkingEnabled" label={t('cliConfig.codebuddy.fields.alwaysThinking')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="showTokensCounter" label={t('cliConfig.codebuddy.fields.showTokens')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="promptSuggestionEnabled" label={t('cliConfig.codebuddy.fields.promptSuggestion')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="memory" label={t('cliConfig.codebuddy.fields.memory')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                    </Space>
                </div>
        ...
        {
            key: 'plugins',
            label: (<span><BuildOutlined />{t('cliConfig.codebuddy.sections.plugins')}</span>),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Divider plain>{t('cliConfig.codebuddy.fields.plugins')}</Divider>
                    ...
                    <Divider plain style={{ marginTop: 32 }}>{t('cliConfig.codebuddy.fields.marketplaces')}</Divider>
        ...
        {
            key: 'advanced',
            label: (<span><ControlOutlined />{t('cliConfig.codebuddy.sections.advanced')}</span>),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Row gutter={16}>
                        <Col span={12}>
                            <Form.Item name="endpoint" label={t('cliConfig.codebuddy.fields.endpoint')}>
                                <Input placeholder="https://api.example.com" />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item name="envRouteMode" label={t('cliConfig.codebuddy.fields.envRouteMode')}>
                                <Select options={[
                                    { label: t('cliConfig.codebuddy.fields.production'), value: 'production' },
                                    { label: t('cliConfig.codebuddy.fields.staging'), value: 'staging' },
                                ]} />
                            </Form.Item>
                        </Col>
                    </Row>
                    <Divider plain>Permissions & Mode</Divider>
                    <Form.Item name={['permissions', 'defaultMode']} label={t('cliConfig.codebuddy.fields.permissions')}>
                        <Select options={[
                            { label: t('cliConfig.codebuddy.fields.plan'), value: 'plan' },
                    ...
                    <Row gutter={16}>
                        ...
                        <Col span={12}>
                            <Form.Item name={['statusLine', 'command']} label={t('cliConfig.codebuddy.fields.statusLineCommand')}>
                                <Input />
                            </Form.Item>
                        </Col>
                    </Row>
