    ...
    const items = [
        {
            ...
            label: (
                <span>
                    <BugOutlined />
                    {t('cliConfig.sections.env', 'Environment')}
                </span>
            ),
            children: (
                <div style={{ padding: '16px 0' }}>
                    ...
                    <Divider plain>{t('cliConfig.sections.controls', 'Feature Controls')}</Divider>
                    <Space wrap>
                    ...
                    <Divider plain>{t('cliConfig.sections.limits', 'Limits')}</Divider>
        ...
        },
        {
            ...
            label: (
                <span>
                    <SettingOutlined />
                    {t('cliConfig.sections.basic', 'Basic')}
                </span>
            ),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Form.Item name="model" label={t('cliConfig.fields.model', 'Model')}>
                        <Input placeholder="claude-3-5-sonnet-20241022" disabled />
                    </Form.Item>
                    <Form.Item name="language" label={t('cliConfig.fields.language', 'Response Language')}>
                        <Select
                            showSearch
                    ...
                    <Form.Item name="cleanupPeriodDays" label={t('cliConfig.fields.cleanupDays', 'Cleanup Period (Days)')}>
                        <InputNumber min={1} style={{ width: '100%' }} />
                    </Form.Item>
                    <Space size="large">
                        <Form.Item name="alwaysThinkingEnabled" label={t('cliConfig.fields.thinkingMode', 'Always Thinking')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="showTurnDuration" label={t('cliConfig.fields.showDuration', 'Show Turn Duration')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                    </Space>
                    <Form.Item name="autoUpdatesChannel" label={t('cliConfig.fields.updateChannel', 'Update Channel')}>
                        <Select options={[
                            { label: 'Stable', value: 'stable' },
                            { label: 'Latest', value: 'latest' },
                        ]} />
                    </Form.Item>
                    <Form.Item name="plansDirectory" label={t('cliConfig.fields.plansDir', 'Plans Directory')}>
                        <Input placeholder="./plans" />
                    </Form.Item>
                    <Space size="large">
                        <Form.Item name="spinnerTipsEnabled" label={t('cliConfig.fields.spinnerTips', 'Spinner Tips')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                        <Form.Item name="terminalProgressBarEnabled" label={t('cliConfig.fields.progressBar', 'Terminal Progress Bar')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                    </Space>
                </div>
        ...
        },
        {
            ...
            label: (
                <span>
                    <SafetyOutlined />
                    {t('cliConfig.sections.permissions', 'Permissions')}
                </span>
            ),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Form.Item name={['permissions', 'defaultMode']} label={t('cliConfig.fields.defaultPermission', 'Default Mode')}>
                        <Select
                    ...
                    <Form.Item name={['permissions', 'allow']} label={t('cliConfig.fields.allowList', 'Allow List')}>
                        <Select mode="tags" placeholder="e.g. Bash(npm run lint)" />
                    </Form.Item>
                    <Form.Item name={['permissions', 'deny']} label={t('cliConfig.fields.denyList', 'Deny List')}>
                        <Select mode="tags" placeholder="e.g. Bash(curl:*)" />
                    </Form.Item>
                    <Form.Item name={['permissions', 'additionalDirectories']} label={t('cliConfig.fields.allowedDirs', 'Additional Directories')}>
        ...
        },
        {
            ...
            label: (
                <span>
                    <ExperimentOutlined />
                    {t('cliConfig.sections.sandbox', 'Sandbox')}
                </span>
            ),
            children: (
                <div style={{ padding: '16px 0' }}>
                    <Space size="large">
                        ...
                        <Form.Item name={['sandbox', 'autoAllowBashIfSandboxed']} label={t('cliConfig.fields.autoAllowBash', 'Auto-Allow Bash in Sandbox')} valuePropName="checked">
                            <Switch />
                        </Form.Item>
                    </Space>
                    <Form.Item name={['sandbox', 'excludedCommands']} label={t('cliConfig.fields.excludedCmds', 'Excluded Commands')}>
                        <Select mode="tags" />
                    </Form.Item>
                    <Divider plain>{t('cliConfig.sections.network', 'Network')}</Divider>
                    <Form.Item name={['sandbox', 'network', 'allowLocalBinding']} label={t('cliConfig.fields.allowLocalBind', 'Allow Local Binding')} valuePropName="checked">
                        <Switch />
                    </Form.Item>
                    <Form.Item name={['sandbox', 'network', 'allowUnixSockets']} label={t('cliConfig.fields.unixSockets', 'Allow Unix Sockets')}>
                        <Select mode="tags" />
                    </Form.Item>
                </div>
            )
