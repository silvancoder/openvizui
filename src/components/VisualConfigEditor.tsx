...
export const TOOL_TEMPLATES: Record<string, ToolTemplate> = {
    Claude: {
        ...
        schema: {
            verbose: { type: 'boolean', label: 'cliConfig.fields.verbose', default: false, description: 'cliConfig.descriptions.verbose' },
            theme: { type: 'string', label: 'cliConfig.fields.theme', options: ['dark', 'light', 'system'], default: 'system' },
            preferredModel: { type: 'string', label: 'cliConfig.fields.preferredModel', default: 'claude-3-opus-20240229' },
            editor: { type: 'string', label: 'cliConfig.fields.editor', description: 'cliConfig.descriptions.editor', default: 'code' },
            autoUpdater: { type: 'boolean', label: 'cliConfig.fields.autoUpdate', default: true },
            maxContextTokens: { type: 'number', label: 'cliConfig.fields.maxContextTokens', default: 200000, description: 'cliConfig.descriptions.limitContext' }
        }
    },
    Gemini: {
        format: 'json',
        ...
        schema: {
            model: { type: 'string', label: 'cliConfig.fields.model', default: 'gemini-1.5-pro', options: ['gemini-1.5-pro', 'gemini-1.5-flash', 'gemini-1.0-pro'] },
            temperature: { type: 'number', label: 'cliConfig.fields.temperature', default: 0.9, description: 'cliConfig.descriptions.randomness' },
            maxOutputTokens: { type: 'number', label: 'cliConfig.fields.maxOutputTokens', default: 8192 },
            topP: { type: 'number', label: 'cliConfig.fields.topP', default: 0.95 },
            topK: { type: 'number', label: 'cliConfig.fields.topK', default: 40 },
            safetySettings: { type: 'string', label: 'cliConfig.fields.safetySettings', description: 'cliConfig.descriptions.safety', default: '{}' }
        }
    },
    OpenCode: {
        format: 'json',
        ...
        schema: {
            // General
            model: { type: 'string', label: 'cliConfig.fields.model', default: 'gpt-4o' },
            theme: { type: 'string', label: 'cliConfig.fields.theme', default: 'opencode', options: ['opencode', 'dark', 'light', 'dracula', 'monokai'] },
            autoupdate: { type: 'boolean', label: 'cliConfig.fields.autoUpdate', default: true },
            default_agent: { type: 'string', label: 'cliConfig.fields.defaultAgent', default: 'plan', options: ['plan', 'code', 'chat'] },
            instructions: { type: 'array', label: 'cliConfig.fields.instructions', default: [], itemType: 'string' },
            disabled_providers: { type: 'array', label: 'cliConfig.fields.disabledProviders', default: [], itemType: 'string' },

            // Server
            "server.port": { type: 'number', label: 'cliConfig.fields.server.port', default: 4096 },
            "server.hostname": { type: 'string', label: 'cliConfig.fields.server.hostname', default: '0.0.0.0' },
            "server.mdns": { type: 'boolean', label: 'cliConfig.fields.server.mdns', default: true },
            "server.cors": { type: 'array', label: 'cliConfig.fields.server.cors', default: [], itemType: 'string' },

            // TUI
            "tui.scroll_speed": { type: 'number', label: 'cliConfig.fields.tui.scrollSpeed', default: 3 },
            "tui.diff_style": { type: 'string', label: 'cliConfig.fields.tui.diffStyle', default: 'auto', options: ['auto', 'side-by-side', 'inline'] },

            // Tools
            "tools.write": { type: 'boolean', label: 'cliConfig.fields.tools.write', default: true },
            "tools.bash": { type: 'boolean', label: 'cliConfig.fields.tools.bash', default: true },

            // Permissions
            "permission.edit": { type: 'string', label: 'cliConfig.fields.permission.edit', default: 'ask', options: ['ask', 'allow', 'deny'] },
            "permission.bash": { type: 'string', label: 'cliConfig.fields.permission.bash', default: 'ask', options: ['ask', 'allow', 'deny'] },

            // Compaction
            "compaction.auto": { type: 'boolean', label: 'cliConfig.fields.compaction.auto', default: true },
            "compaction.prune": { type: 'boolean', label: 'cliConfig.fields.compaction.prune', default: true },

            // Provider Options (Example: Anthropic)
            "provider.anthropic.options.timeout": { type: 'number', label: 'cliConfig.fields.provider.timeout', default: 600000 },
        }
    },
    Qoder: {
        format: 'json',
        ...
        schema: {
            autoUpdate: { type: 'boolean', label: 'cliConfig.fields.autoUpdate', default: true },
            language: { type: 'string', label: 'cliConfig.fields.language', options: ['en', 'zh'], default: 'en' },
            "privacy.telemetry": { type: 'boolean', label: 'cliConfig.fields.telemetry', default: true },
            "permissions.default": { type: 'string', label: 'cliConfig.fields.defaultPermission', options: ['ask', 'allow', 'deny'], default: 'ask' }
        }
    },
    CodeBuddy: {
        format: 'json',
        ...
        schema: {
            language: { type: 'string', label: 'cliConfig.fields.language', options: ['zh-CN', 'en-US'], default: 'zh-CN' },
            api_key: { type: 'string', label: 'cliConfig.fields.apiKey', description: 'cliConfig.descriptions.tencentKey' },
            model: { type: 'string', label: 'cliConfig.fields.model', default: 'hunyuan-pro' },
            "editor.integration": { type: 'boolean', label: 'cliConfig.fields.editorIntegration', default: true }
        }
    },
    Copilot: {
        format: 'json',
        ...
        schema: {
            editor: { type: 'string', label: 'cliConfig.fields.editor', default: 'code' },
            debug: { type: 'boolean', label: 'cliConfig.fields.debugMode', default: false },
            confirm_execute: { type: 'boolean', label: 'cliConfig.fields.confirmExecute', default: true, description: 'cliConfig.descriptions.confirmExecute' },
            "github.token": { type: 'string', label: 'cliConfig.fields.githubToken', description: 'cliConfig.descriptions.githubToken' }
        }
    },
    Codex: {
        format: 'toml',
        ...
        schema: {
            model_provider: { type: 'string', label: 'cliConfig.fields.modelProvider', default: 'openai', options: ['openai', 'anthropic'], description: 'cliConfig.descriptions.modelProvider' },
            "_v_provider.base_url": { type: 'string', label: 'cliConfig.fields.provider.baseUrl', default: 'https://api.url/v1' },
            "_v_provider.name": { type: 'string', label: 'cliConfig.fields.provider.name', default: '' },
            model: { type: 'string', label: 'cliConfig.fields.model', default: '' },
            model_reasoning_effort: { type: 'string', label: 'cliConfig.fields.reasoningEffort', default: 'high', options: ['high', 'medium', 'low'] },
            disable_response_storage: { type: 'boolean', label: 'cliConfig.fields.disableResponseStorage', default: true },
            preferred_auth_method: { type: 'string', label: 'cliConfig.fields.preferredAuthMethod', default: 'apikey', options: ['apikey', 'oauth'] },
        }
    }
};
                        ...
                        return (
                            <Form.Item key={key} label={label} tooltip={description}>
                                <Row gutter={8}>
                                    <Col span={8}>
                                        <Select
                                            placeholder={t('cliConfig.fields.providerName', 'Provider')}
                                            options={[
                                                {
