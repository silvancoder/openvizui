...
OpenVizUI — это современное настольное приложение, созданное с использованием [Tauri](https://tauri.app/), [React](https://react.dev/) и [Vite](https://vitejs.dev/). Оно использует мощь Rust для бэкенда и гибкость React для фронтенда пользовательского интерфейса.
