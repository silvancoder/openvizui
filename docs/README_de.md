...
-   `CHANGELOG.md`: [Detaillierte Historie der Projektänderungen](../CHANGELOG.md).

## Changelog

Eine detaillierte Historie der Änderungen finden Sie unter [CHANGELOG.md](../CHANGELOG.md).
